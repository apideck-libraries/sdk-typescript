 ...
 * Delete Journal
 */
export function accountingJournalsDelete(
  client: ApideckCore,
  request: operations.AccountingJournalsDeleteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AccountingJournalsDeleteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingJournalsDeleteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingJournalsDeleteResponse$inboundSchema, {
    ...
    M.json(
      "default",
      operations.AccountingJournalsDeleteResponse$inboundSchema,
