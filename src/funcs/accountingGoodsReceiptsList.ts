 ...
 * List Goods Receipts
 */
export function accountingGoodsReceiptsList(
  client: ApideckCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingGoodsReceiptsAllRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/accounting/goods-receipts")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingGoodsReceiptsAllResponse$inboundSchema, {
      key: "GetGoodsReceiptsResponse",
    }),
    ...
    M.json(
      "default",
      operations.AccountingGoodsReceiptsAllResponse$inboundSchema,
