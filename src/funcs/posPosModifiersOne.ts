 ...
 * Get Modifier
 */
export async function posPosModifiersOne(
  client: ApideckCore,
  request: operations.PosModifiersOneRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.PosModifiersOneResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PosModifiersOneRequest$outboundSchema.parse(value),
