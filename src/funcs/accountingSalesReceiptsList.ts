 ...
 * List Sales Receipts
 */
export function accountingSalesReceiptsList(
  client: ApideckCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingSalesReceiptsAllRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingSalesReceiptsAllResponse$inboundSchema, {
      key: "GetSalesReceiptsResponse",
    }),
    ...
    M.json(
      "default",
      operations.AccountingSalesReceiptsAllResponse$inboundSchema,
