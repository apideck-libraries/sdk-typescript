 ...
 * Delete lead
 */
export async function leadLeadLeadsDelete(
  client: ApideckCore,
  request: operations.LeadLeadsDeleteRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.LeadLeadsDeleteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LeadLeadsDeleteRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lead/leads/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.LeadLeadsDeleteResponse$inboundSchema),
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.LeadLeadsDeleteResponse$inboundSchema),
