 ...
 * List Orders
 */
export async function posPosOrdersAll(
  client: ApideckCore,
  request: operations.PosOrdersAllRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.PosOrdersAllResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PosOrdersAllRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PosOrdersAllResponse$inboundSchema, {
      key: "GetOrdersResponse",
    }),
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.PosOrdersAllResponse$inboundSchema, {
