 ...
 */
export function crmListMembersList(
  client: ApideckCore,
  ...
  PageIterator<
    Result<
      operations.CrmListMembersAllResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CrmListMembersAllRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/crm/lists/{id}/members")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CrmListMembersAllResponse$inboundSchema, {
      key: "GetListMembersResponse",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.CrmListMembersAllResponse$inboundSchema, {
