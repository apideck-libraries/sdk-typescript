...
export function accountingJournalsList(
  ...
  PageIterator<
    Result<
      operations.AccountingJournalsAllResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingJournalsAllRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingJournalsAllResponse$inboundSchema, {
      key: "GetJournalsResponse",
    }),
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.AccountingJournalsAllResponse$inboundSchema, {
