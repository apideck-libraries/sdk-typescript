 ...
 */
export async function posPosOrdersUpdate(
  client: ApideckCore,
  request: operations.PosOrdersUpdateRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.PosOrdersUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PosOrdersUpdateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PosOrdersUpdateResponse$inboundSchema, {
      key: "UpdateOrderResponse",
    }),
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.PosOrdersUpdateResponse$inboundSchema, {
