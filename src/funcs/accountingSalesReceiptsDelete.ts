 ...
 * Delete Sales Receipt
 */
export function accountingSalesReceiptsDelete(
  client: ApideckCore,
  request: operations.AccountingSalesReceiptsDeleteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AccountingSalesReceiptsDeleteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingSalesReceiptsDeleteRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AccountingSalesReceiptsDeleteResponse$inboundSchema,
      { key: "DeleteSalesReceiptResponse" },
    ),
