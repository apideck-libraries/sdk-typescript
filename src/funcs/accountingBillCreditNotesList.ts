 ...
 * List Bill Credit Notes
 */
export function accountingBillCreditNotesList(
  client: ApideckCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingBillCreditNotesAllRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/accounting/bill-credit-notes")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingBillCreditNotesAllResponse$inboundSchema, {
      key: "GetBillCreditNotesResponse",
    }),
    ...
    M.json(
      "default",
      operations.AccountingBillCreditNotesAllResponse$inboundSchema,
