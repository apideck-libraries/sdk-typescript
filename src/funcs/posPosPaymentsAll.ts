 ...
 * List Payments
 */
export async function posPosPaymentsAll(
  client: ApideckCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PosPaymentsAllRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PosPaymentsAllResponse$inboundSchema, {
      key: "GetPosPaymentsResponse",
    }),
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.PosPaymentsAllResponse$inboundSchema, {
