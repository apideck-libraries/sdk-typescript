 ...
 */
export function vaultConnectionsMigrate(
  client: ApideckCore,
  request: operations.VaultConnectionsMigrateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.VaultConnectionsMigrateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.VaultConnectionsMigrateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ConnectionMigrateData, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VaultConnectionsMigrateResponse$inboundSchema, {
    ...
    M.json(
      "default",
      operations.VaultConnectionsMigrateResponse$inboundSchema,
