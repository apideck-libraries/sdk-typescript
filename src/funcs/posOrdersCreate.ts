 ...
 * Create Order
 */
export async function posOrdersCreate(
  client: ApideckCore,
  request: operations.PosOrdersAddRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.PosOrdersAddResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PosOrdersAddRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.PosOrdersAddResponse$inboundSchema, {
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.PosOrdersAddResponse$inboundSchema, {
