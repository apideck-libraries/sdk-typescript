...
test("Folders File Storage Folders Add", async () => {
  const testHttpClient = createTestHTTPClient("fileStorage.foldersAdd");
  ...
  expect(result.createFolderResponse).toBeDefined();
  expect(result.createFolderResponse).toEqual({
    statusCode: 200,
    status: "OK",
    service: "undefined",
    resource: "Folders",
...
test("Folders File Storage Folders Update", async () => {
  const testHttpClient = createTestHTTPClient("fileStorage.foldersUpdate");
  ...
  expect(result.httpMeta.response.status).toBe(200);
  expect(result.updateFolderResponse).toBeDefined();
  expect(result.updateFolderResponse).toEqual({
    statusCode: 200,
    status: "OK",
    service: "undefined",
    resource: "Folders",
...
test("Folders File Storage Folders Copy", async () => {
  const testHttpClient = createTestHTTPClient("fileStorage.foldersCopy");
