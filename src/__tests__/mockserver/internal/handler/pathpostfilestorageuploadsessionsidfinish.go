...
func pathPostFileStorageUploadSessionsIDFinish(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		case "fileStorage.uploadSessionsFinish[0]":
			dir.HandlerFunc("fileStorage.uploadSessionsFinish", testFileStorageUploadSessionsFinishFileStorageUploadSessionsFinish0)(w, req)
		default:
...
func testFileStorageUploadSessionsFinishFileStorageUploadSessionsFinish0(w http.ResponseWriter, req *http.Request) {
