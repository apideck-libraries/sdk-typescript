...
func (o *HrisTimeOffRequestsAllRequest) GetCursor() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Cursor
...
func (o *HrisTimeOffRequestsAllRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
