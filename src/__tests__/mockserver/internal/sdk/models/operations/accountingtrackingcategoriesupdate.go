...
type AccountingTrackingCategoriesUpdateRequest struct {
	...
	Body components.TrackingCategoryInput `request:"mediaType=application/json"`
}
...
func (o *AccountingTrackingCategoriesUpdateRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingTrackingCategoriesUpdateRequest) GetBody() components.TrackingCategoryInput {
	if o == nil {
