...
func (o *AccountingBankFeedStatementsOneRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingBankFeedStatementsOneRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
