...
func (o *AccountingAttachmentsAllRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingAttachmentsAllRequest) GetCursor() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Cursor
...
func (o *AccountingAttachmentsAllRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
...
func (o *AccountingAttachmentsAllRequest) GetPassThrough() map[string]any {
	if o == nil {
		return nil
	}
