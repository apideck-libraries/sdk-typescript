...
func (o *AccountingAgedCreditorsOneRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingAgedCreditorsOneRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
