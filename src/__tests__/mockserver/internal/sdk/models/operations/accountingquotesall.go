...
func (o *AccountingQuotesAllRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingQuotesAllRequest) GetCursor() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Cursor
...
func (o *AccountingQuotesAllRequest) GetPassThrough() map[string]any {
	if o == nil {
		return nil
	}
