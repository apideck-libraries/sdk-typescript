...
func (o *AccountingJournalEntriesOneRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingJournalEntriesOneRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
