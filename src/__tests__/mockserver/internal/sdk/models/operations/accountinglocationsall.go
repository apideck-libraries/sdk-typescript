...
func (o *AccountingLocationsAllRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingLocationsAllRequest) GetCursor() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Cursor
...
func (o *AccountingLocationsAllRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
...
func (o *AccountingLocationsAllRequest) GetPassThrough() map[string]any {
	if o == nil {
		return nil
	}
