...
func (o *AccountingCategoriesAllRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingCategoriesAllRequest) GetCursor() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Cursor
...
func (o *AccountingCategoriesAllRequest) GetFields() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Fields
...
func (o *AccountingCategoriesAllRequest) GetPassThrough() map[string]any {
	if o == nil {
		return nil
	}
