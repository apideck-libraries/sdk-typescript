...
func (o *AccountingTrackingCategoriesAddRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingTrackingCategoriesAddRequest) GetBody() components.TrackingCategoryInput {
	if o == nil {
