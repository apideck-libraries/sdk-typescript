...
type AccountingLedgerAccountsAddRequest struct {
	...
	Body      components.LedgerAccountInput `request:"mediaType=application/json"`
}
...
func (o *AccountingLedgerAccountsAddRequest) GetCompanyID() *string {
	if o == nil {
		return nil
	}
	return o.CompanyID
...
func (o *AccountingLedgerAccountsAddRequest) GetBody() components.LedgerAccountInput {
	if o == nil {
