...
func (o *Refund) GetTotalAmount() optionalnullable.OptionalNullable[float64] {
	if o == nil {
		return nil
	}
...
func (o *Refund) GetCustomFields() []CustomField {
	if o == nil {
		return nil
	}
...
func (o *Refund) GetAdditionalProperties() map[string]any {
	if o == nil {
		return nil
	}
