...
func (o *Subsidiary) GetAdditionalProperties() map[string]any {
	if o == nil {
		return nil
	}
...
func (s SubsidiaryInput) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(s, "", false)
}

func (s *SubsidiaryInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (o *SubsidiaryInput) GetAdditionalProperties() map[string]any {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
