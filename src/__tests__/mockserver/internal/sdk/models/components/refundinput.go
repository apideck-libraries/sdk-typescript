...
func (r *RefundInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &r, "", false, []string{"total_amount"}); err != nil {
		return err
	}
	return nil
}
...
func (o *RefundInput) GetTotalAmount() *float64 {
	if o == nil {
		return nil
	}
...
func (o *RefundInput) GetCustomFields() []CustomFieldUnion {
	if o == nil {
		return nil
	}
