...
func (o *CustomField) GetID() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *CustomField) GetName() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Name
...
func (o *CustomField) GetDescription() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
...
func (o *CustomField) GetValue() optionalnullable.OptionalNullable[CustomFieldValue2] {
	if o == nil {
		return nil
	}
	return o.Value
...
func (o *CustomField) GetAdditionalProperties() map[string]any {
	if o == nil {
		return nil
	}
