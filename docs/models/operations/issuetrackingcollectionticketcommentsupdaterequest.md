...
```typescript
import { IssueTrackingCollectionTicketCommentsUpdateRequest } from "@apideck/unify/models/operations";
...
| `ticketId`                                                                                                                                    | *string*                                                                                                                                      | :heavy_check_mark:                                                                                                                            | ID of the ticket you are acting upon.                                                                                                         | ticket_id_example                                                                                                                             |
