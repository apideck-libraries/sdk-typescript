...
```typescript
import { AccountingSalesReceiptsUpdateRequest } from "@apideck/unify/models/operations";

let value: AccountingSalesReceiptsUpdateRequest = {
  id: "<id>",
...
| `salesReceipt`                                                                                                                                               | [components.SalesReceiptInput](../../models/components/salesreceiptinput.md)                                                                                 | :heavy_check_mark:                                                                                                                                           | N/A                                                                                                                                                          |                                                                                                                                                              |