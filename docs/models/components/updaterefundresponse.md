...
```typescript
import { UpdateRefundResponse } from "@apideck/unify/models/components";

let value: UpdateRefundResponse = {
  statusCode: 200,
  status: "OK",
  service: "quickbooks",
  resource: "refunds",
...
| `resource`                                                                                      | *string*                                                                                        | :heavy_check_mark:                                                                              | Unified API resource name                                                                       | refunds                                                                                         |
