...
```typescript
import { BillCreditNoteInput } from "@apideck/unify/models/components";

let value: BillCreditNoteInput = {
  number: "OIT00546",
  supplier: {
    id: "12345",
...
| `totalAmount`                                                                                                                                           | *number*                                                                                                                                                | :heavy_minus_sign:                                                                                                                                      | Amount of transaction                                                                                                                                   | 49.99                                                                                                                                                   |
...
| `lineItems`                                                                                                                                             | [components.BillCreditNoteLineItemInput](../../models/components/billcreditnotelineiteminput.md)[]                                                      | :heavy_minus_sign:                                                                                                                                      | N/A                                                                                                                                                     |                                                                                                                                                         |
