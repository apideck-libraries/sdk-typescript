...
| `deliveryUrl`                                                                                                                | *string*                                                                                                                     | :heavy_minus_sign:                                                                                                           | The delivery url of the webhook endpoint. The endpoint must respond within 60 seconds or the delivery is recorded as failed. | https://example.com/my/webhook/endpoint                                                                                      |
