...
```typescript
import { LinkedPaymentAllocations } from "@apideck/unify/models/components";

let value: LinkedPaymentAllocations = {
  id: "123456",
...
| `allocatedAmount`                                                                             | *number*                                                                                      | :heavy_minus_sign:                                                                            | Amount of the payment allocated to the bill                                                   | 1000                                                                                          |
