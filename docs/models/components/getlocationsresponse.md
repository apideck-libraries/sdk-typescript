...
```typescript
import { GetLocationsResponse } from "apideck/models/components";

let value: GetLocationsResponse = {
  statusCode: 200,
  status: "OK",
  service: "square",
  resource: "Locations",
...
| `data`                                                       | [components.Location](../../models/components/location.md)[] | :heavy_check_mark:                                           | N/A                                                          |                                                              |
