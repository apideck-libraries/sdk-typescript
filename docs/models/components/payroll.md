...
```typescript
import { Payroll } from "@apideck/unify/models/components";
...
| `processed`                                                                                                 | *boolean*                                                                                                   | :heavy_minus_sign:                                                                                          | Whether or not the payroll has been successfully processed. Note that processed payrolls cannot be updated. | false                                                                                                       |
