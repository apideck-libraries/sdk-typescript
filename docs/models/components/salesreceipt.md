...
```typescript
import { SalesReceipt } from "@apideck/unify/models/components";

let value: SalesReceipt = {
  id: "123456",
  number: "SR-00001",
  customer: {
    id: "12345",
...
| `transactionDate`                                                                                                                                       | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)                                                           | :heavy_minus_sign:                                                                                                                                      | The date of the sales receipt transaction - YYYY-MM-DDThh:mm:ss.sTZD                                                                                    | 2021-05-01T12:00:00.000Z                                                                                                                                |
...
| `lineItems`                                                                                                                                             | [components.InvoiceLineItem](../../models/components/invoicelineitem.md)[]                                                                              | :heavy_minus_sign:                                                                                                                                      | Line items for itemized sales receipts. Used when the sales receipt includes product/service details with quantities and pricing.                       |                                                                                                                                                         |
| `taxCode`                                                                                                                                               | *string*                                                                                                                                                | :heavy_minus_sign:                                                                                                                                      | Applicable tax id/code override if tax is not supplied on a line item basis.                                                                            | 1234                                                                                                                                                    |
| `discountPercentage`                                                                                                                                    | *number*                                                                                                                                                | :heavy_minus_sign:                                                                                                                                      | Discount percentage applied to this sales receipt.                                                                                                      | 5.5                                                                                                                                                     |
| `discountAmount`                                                                                                                                        | *number*                                                                                                                                                | :heavy_minus_sign:                                                                                                                                      | Discount amount applied to this sales receipt.                                                                                                          | 25                                                                                                                                                      |
