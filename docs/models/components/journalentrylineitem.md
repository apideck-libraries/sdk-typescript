...
| `baseCurrencyAmount`                                                                                                                | *number*                                                                                                                            | :heavy_minus_sign:                                                                                                                  | Amount for this line in the company's base currency. Used when the journal entry currency differs from the company's base currency. | 27500                                                                                                                               |
...
| `taxType`                                                                                                                           | [components.TaxType](../../models/components/taxtype.md)                                                                            | :heavy_minus_sign:                                                                                                                  | The tax applicability of this line item. Overrides the root-level tax_type for this line.                                           | sales                                                                                                                               |
...
| `employee`                                                                                                                          | [components.LinkedEmployee](../../models/components/linkedemployee.md)                                                              | :heavy_minus_sign:                                                                                                                  | The employee this entity is linked to.                                                                                              |                                                                                                                                     |
