...
```typescript
import { Unauthorized } from "@apideck/unify/models/errors";
...
| `detail`                                                                                    | *errors.UnauthorizedDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
