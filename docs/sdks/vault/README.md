...
* [vaultConsumersAdd](#vaultconsumersadd) - Create consumer
* [vaultConsumersAll](#vaultconsumersall) - Get all consumers
* [vaultConsumersOne](#vaultconsumersone) - Get consumer
* [vaultConsumersUpdate](#vaultconsumersupdate) - Update consumer
* [vaultConsumersDelete](#vaultconsumersdelete) - Delete consumer
* [vaultConsumerRequestCountsAll](#vaultconsumerrequestcountsall) - Consumer request counts
* [vaultConnectionsAll](#vaultconnectionsall) - Get all connections
* [vaultConnectionsOne](#vaultconnectionsone) - Get connection
* [vaultConnectionsUpdate](#vaultconnectionsupdate) - Update connection
* [vaultConnectionsDelete](#vaultconnectionsdelete) - Deletes a connection
* [vaultConnectionsImport](#vaultconnectionsimport) - Import connection
* [vaultConnectionsToken](#vaultconnectionstoken) - Authorize Access Token
* [vaultValidateConnectionState](#vaultvalidateconnectionstate) - Validate Connection State
* [vaultCreateCallbackState](#vaultcreatecallbackstate) - Create Callback State
* [vaultConnectionSettingsAll](#vaultconnectionsettingsall) - Get resource settings
* [vaultConnectionSettingsUpdate](#vaultconnectionsettingsupdate) - Update settings
* [vaultCustomFieldsAll](#vaultcustomfieldsall) - Get resource custom fields
* [vaultConnectionCustomMappingsAll](#vaultconnectioncustommappingsall) - List connection custom mappings
* [vaultCustomMappingsAll](#vaultcustommappingsall) - List custom mappings
* [vaultSessionsCreate](#vaultsessionscreate) - Create Session
* [vaultLogsAll](#vaultlogsall) - Get all consumer request logs
...
async function run() {
  const result = await apideck.vault.vaultConsumersAdd({
...
import { vaultVaultConsumersAdd } from "apideck/funcs/vaultVaultConsumersAdd.js";
...
async function run() {
  const res = await vaultVaultConsumersAdd(apideck, {
    consumerId: "test_consumer_id",
    metadata: {
      accountName: "SpaceX",
      userName: "Elon Musk",
...
async function run() {
  const result = await apideck.vault.vaultConsumersAll({});
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConsumersAll } from "apideck/funcs/vaultVaultConsumersAll.js";
...
async function run() {
  const res = await vaultVaultConsumersAll(apideck, {});
...
async function run() {
  const result = await apideck.vault.vaultConsumersOne({
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConsumersOne } from "apideck/funcs/vaultVaultConsumersOne.js";
...
async function run() {
  const res = await vaultVaultConsumersOne(apideck, {
    consumerId: "test_user_id",
  });
...
async function run() {
  const result = await apideck.vault.vaultConsumersUpdate({
    consumerId: "test_user_id",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConsumersUpdate } from "apideck/funcs/vaultVaultConsumersUpdate.js";
...
async function run() {
  const res = await vaultVaultConsumersUpdate(apideck, {
    consumerId: "test_user_id",
    updateConsumerRequest: {
      metadata: {
        accountName: "SpaceX",
...
async function run() {
  const result = await apideck.vault.vaultConsumersDelete({
    consumerId: "test_user_id",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConsumersDelete } from "apideck/funcs/vaultVaultConsumersDelete.js";
...
async function run() {
  const res = await vaultVaultConsumersDelete(apideck, {
    consumerId: "test_user_id",
  });
...
async function run() {
  const result = await apideck.vault.vaultConsumerRequestCountsAll({
    consumerId: "test_user_id",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConsumerRequestCountsAll } from "apideck/funcs/vaultVaultConsumerRequestCountsAll.js";
...
async function run() {
  const res = await vaultVaultConsumerRequestCountsAll(apideck, {
    consumerId: "test_user_id",
    startDatetime: "2021-05-01T12:00:00.000Z",
    endDatetime: "2021-05-30T12:00:00.000Z",
  });
...
async function run() {
  const result = await apideck.vault.vaultConnectionsAll({
    api: "crm",
    configured: true,
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsAll } from "apideck/funcs/vaultVaultConnectionsAll.js";
...
async function run() {
  const res = await vaultVaultConnectionsAll(apideck, {
    api: "crm",
    configured: true,
  });
...
async function run() {
  const result = await apideck.vault.vaultConnectionsOne({
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsOne } from "apideck/funcs/vaultVaultConnectionsOne.js";
...
async function run() {
  const res = await vaultVaultConnectionsOne(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
async function run() {
  const result = await apideck.vault.vaultConnectionsUpdate({
    serviceId: "pipedrive",
    unifiedApi: "crm",
    connection: {
      enabled: true,
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsUpdate } from "apideck/funcs/vaultVaultConnectionsUpdate.js";
...
async function run() {
  const res = await vaultVaultConnectionsUpdate(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
    connection: {
      enabled: true,
...
async function run() {
  const result = await apideck.vault.vaultConnectionsDelete({
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsDelete } from "apideck/funcs/vaultVaultConnectionsDelete.js";
...
async function run() {
  const res = await vaultVaultConnectionsDelete(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
async function run() {
  const result = await apideck.vault.vaultConnectionsImport({
    serviceId: "pipedrive",
    unifiedApi: "crm",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsImport } from "apideck/funcs/vaultVaultConnectionsImport.js";
...
async function run() {
  const res = await vaultVaultConnectionsImport(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
    connectionImportData: {
      credentials: {
...
async function run() {
  const result = await apideck.vault.vaultConnectionsToken({
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionsToken } from "apideck/funcs/vaultVaultConnectionsToken.js";
...
async function run() {
  const res = await vaultVaultConnectionsToken(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
async function run() {
  const result = await apideck.vault.vaultValidateConnectionState({
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultValidateConnectionState } from "apideck/funcs/vaultVaultValidateConnectionState.js";
...
async function run() {
  const res = await vaultVaultValidateConnectionState(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
  });
...
async function run() {
  const result = await apideck.vault.vaultCreateCallbackState({
    serviceId: "pipedrive",
    unifiedApi: "crm",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultCreateCallbackState } from "apideck/funcs/vaultVaultCreateCallbackState.js";
...
async function run() {
  const res = await vaultVaultCreateCallbackState(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
    createCallbackStateData: {
      redirectUri: "https://example.com/callback",
...
**Promise\<[operations.VaultCreateCallbackStateResponse](../../models/operations/vaultcreatecallbackstateresponse.md)\>**
...
async function run() {
  const result = await apideck.vault.vaultConnectionSettingsAll({
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionSettingsAll } from "apideck/funcs/vaultVaultConnectionSettingsAll.js";
...
async function run() {
  const res = await vaultVaultConnectionSettingsAll(apideck, {
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
  });
...
async function run() {
  const result = await apideck.vault.vaultConnectionSettingsUpdate({
    serviceId: "pipedrive",
    unifiedApi: "crm",
    resource: "leads",
    connection: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionSettingsUpdate } from "apideck/funcs/vaultVaultConnectionSettingsUpdate.js";
...
async function run() {
  const res = await vaultVaultConnectionSettingsUpdate(apideck, {
    serviceId: "pipedrive",
    unifiedApi: "crm",
    resource: "leads",
    connection: {
...
async function run() {
  const result = await apideck.vault.vaultCustomFieldsAll({
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
    resourceId: "1234",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultCustomFieldsAll } from "apideck/funcs/vaultVaultCustomFieldsAll.js";
...
async function run() {
  const res = await vaultVaultCustomFieldsAll(apideck, {
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
    resourceId: "1234",
...
**Promise\<[operations.VaultCustomFieldsAllResponse](../../models/operations/vaultcustomfieldsallresponse.md)\>**
...
## vaultConnectionCustomMappingsAll
...
async function run() {
  const result = await apideck.vault.vaultConnectionCustomMappingsAll({
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
    resourceId: "1234",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultConnectionCustomMappingsAll } from "apideck/funcs/vaultVaultConnectionCustomMappingsAll.js";
...
async function run() {
  const res = await vaultVaultConnectionCustomMappingsAll(apideck, {
    unifiedApi: "crm",
    serviceId: "pipedrive",
    resource: "leads",
    resourceId: "1234",
...
**Promise\<[operations.VaultConnectionCustomMappingsAllResponse](../../models/operations/vaultconnectioncustommappingsallresponse.md)\>**
...
async function run() {
  const result = await apideck.vault.vaultCustomMappingsAll({
    unifiedApi: "crm",
    serviceId: "pipedrive",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultCustomMappingsAll } from "apideck/funcs/vaultVaultCustomMappingsAll.js";
...
async function run() {
  const res = await vaultVaultCustomMappingsAll(apideck, {
    unifiedApi: "crm",
    serviceId: "pipedrive",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.VaultCustomMappingsAllRequest](../../models/operations/vaultcustommappingsallrequest.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.VaultCustomMappingsAllResponse](../../models/operations/vaultcustommappingsallresponse.md)\>**
...
async function run() {
  const result = await apideck.vault.vaultSessionsCreate({
    consumerMetadata: {
      accountName: "SpaceX",
      userName: "Elon Musk",
      email: "elon@musk.com",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultSessionsCreate } from "apideck/funcs/vaultVaultSessionsCreate.js";
...
async function run() {
  const res = await vaultVaultSessionsCreate(apideck, {
    consumerMetadata: {
      accountName: "SpaceX",
      userName: "Elon Musk",
      email: "elon@musk.com",
...
async function run() {
  const result = await apideck.vault.vaultLogsAll({
    filter: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { vaultVaultLogsAll } from "apideck/funcs/vaultVaultLogsAll.js";
...
async function run() {
  const res = await vaultVaultLogsAll(apideck, {
    filter: {
      connectorId: "crm+salesforce",
      statusCode: 201,
      excludeUnifiedApis: "vault,proxy",
