...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageDrivesList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageDrivesCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageDrivesGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageDrivesUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageDrivesDelete failed:", res.error);
  }
}
