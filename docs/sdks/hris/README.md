...
* [hrisEmployeesAll](#hrisemployeesall) - List Employees
* [hrisEmployeesAdd](#hrisemployeesadd) - Create Employee
* [hrisEmployeesOne](#hrisemployeesone) - Get Employee
* [hrisEmployeesUpdate](#hrisemployeesupdate) - Update Employee
* [hrisEmployeesDelete](#hrisemployeesdelete) - Delete Employee
* [hrisCompaniesAll](#hriscompaniesall) - List Companies
* [hrisCompaniesAdd](#hriscompaniesadd) - Create Company
* [hrisCompaniesOne](#hriscompaniesone) - Get Company
* [hrisCompaniesUpdate](#hriscompaniesupdate) - Update Company
* [hrisCompaniesDelete](#hriscompaniesdelete) - Delete Company
* [hrisDepartmentsAll](#hrisdepartmentsall) - List Departments
* [hrisDepartmentsAdd](#hrisdepartmentsadd) - Create Department
* [hrisDepartmentsOne](#hrisdepartmentsone) - Get Department
* [hrisDepartmentsUpdate](#hrisdepartmentsupdate) - Update Department
* [hrisDepartmentsDelete](#hrisdepartmentsdelete) - Delete Department
* [hrisPayrollsAll](#hrispayrollsall) - List Payroll
* [hrisPayrollsOne](#hrispayrollsone) - Get Payroll
* [hrisEmployeePayrollsAll](#hrisemployeepayrollsall) - List Employee Payrolls
* [hrisEmployeePayrollsOne](#hrisemployeepayrollsone) - Get Employee Payroll
* [hrisEmployeeSchedulesAll](#hrisemployeeschedulesall) - List Employee Schedules
* [hrisTimeOffRequestsAll](#hristimeoffrequestsall) - List Time Off Requests
* [hrisTimeOffRequestsAdd](#hristimeoffrequestsadd) - Create Time Off Request
* [hrisTimeOffRequestsOne](#hristimeoffrequestsone) - Get Time Off Request
* [hrisTimeOffRequestsUpdate](#hristimeoffrequestsupdate) - Update Time Off Request
* [hrisTimeOffRequestsDelete](#hristimeoffrequestsdelete) - Delete Time Off Request
...
async function run() {
  const result = await apideck.hris.hrisEmployeesAll({
...
import { hrisHrisEmployeesAll } from "apideck/funcs/hrisHrisEmployeesAll.js";
...
async function run() {
  const res = await hrisHrisEmployeesAll(apideck, {
    serviceId: "salesforce",
    filter: {
      companyId: "1234",
      email: "elon@tesla.com",
...
async function run() {
  const result = await apideck.hris.hrisEmployeesAdd({
    serviceId: "salesforce",
    employee: {
      id: "12345",
      firstName: "Elon",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeesAdd } from "apideck/funcs/hrisHrisEmployeesAdd.js";
import { RFCDate } from "apideck/types";
...
async function run() {
  const res = await hrisHrisEmployeesAdd(apideck, {
    serviceId: "salesforce",
    employee: {
      id: "12345",
      firstName: "Elon",
...
async function run() {
  const result = await apideck.hris.hrisEmployeesOne({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
    filter: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeesOne } from "apideck/funcs/hrisHrisEmployeesOne.js";
...
async function run() {
  const res = await hrisHrisEmployeesOne(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
    filter: {
...
async function run() {
  const result = await apideck.hris.hrisEmployeesUpdate({
    id: "<id>",
    serviceId: "salesforce",
    employee: {
      id: "12345",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeesUpdate } from "apideck/funcs/hrisHrisEmployeesUpdate.js";
import { RFCDate } from "apideck/types";
...
async function run() {
  const res = await hrisHrisEmployeesUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    employee: {
      id: "12345",
...
async function run() {
  const result = await apideck.hris.hrisEmployeesDelete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeesDelete } from "apideck/funcs/hrisHrisEmployeesDelete.js";
...
async function run() {
  const res = await hrisHrisEmployeesDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
...
async function run() {
  const result = await apideck.hris.hrisCompaniesAll({
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
    },
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisCompaniesAll } from "apideck/funcs/hrisHrisCompaniesAll.js";
...
async function run() {
  const res = await hrisHrisCompaniesAll(apideck, {
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
    },
...
async function run() {
  const result = await apideck.hris.hrisCompaniesAdd({
    serviceId: "salesforce",
    hrisCompany: {
      legalName: "SpaceX",
      displayName: "SpaceX",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisCompaniesAdd } from "apideck/funcs/hrisHrisCompaniesAdd.js";
...
async function run() {
  const res = await hrisHrisCompaniesAdd(apideck, {
    serviceId: "salesforce",
    hrisCompany: {
      legalName: "SpaceX",
      displayName: "SpaceX",
...
async function run() {
  const result = await apideck.hris.hrisCompaniesOne({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisCompaniesOne } from "apideck/funcs/hrisHrisCompaniesOne.js";
...
async function run() {
  const res = await hrisHrisCompaniesOne(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.hris.hrisCompaniesUpdate({
    id: "<id>",
    serviceId: "salesforce",
    hrisCompany: {
      legalName: "SpaceX",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisCompaniesUpdate } from "apideck/funcs/hrisHrisCompaniesUpdate.js";
...
async function run() {
  const res = await hrisHrisCompaniesUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    hrisCompany: {
      legalName: "SpaceX",
...
async function run() {
  const result = await apideck.hris.hrisCompaniesDelete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisCompaniesDelete } from "apideck/funcs/hrisHrisCompaniesDelete.js";
...
async function run() {
  const res = await hrisHrisCompaniesDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
...
async function run() {
  const result = await apideck.hris.hrisDepartmentsAll({
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
    },
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisDepartmentsAll } from "apideck/funcs/hrisHrisDepartmentsAll.js";
...
async function run() {
  const res = await hrisHrisDepartmentsAll(apideck, {
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
    },
...
async function run() {
  const result = await apideck.hris.hrisDepartmentsAdd({
    serviceId: "salesforce",
    department: {
      name: "R&D",
      code: "2",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisDepartmentsAdd } from "apideck/funcs/hrisHrisDepartmentsAdd.js";
...
async function run() {
  const res = await hrisHrisDepartmentsAdd(apideck, {
    serviceId: "salesforce",
    department: {
      name: "R&D",
      code: "2",
...
async function run() {
  const result = await apideck.hris.hrisDepartmentsOne({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisDepartmentsOne } from "apideck/funcs/hrisHrisDepartmentsOne.js";
...
async function run() {
  const res = await hrisHrisDepartmentsOne(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.hris.hrisDepartmentsUpdate({
    id: "<id>",
    serviceId: "salesforce",
    department: {
      name: "R&D",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisDepartmentsUpdate } from "apideck/funcs/hrisHrisDepartmentsUpdate.js";
...
async function run() {
  const res = await hrisHrisDepartmentsUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    department: {
      name: "R&D",
...
async function run() {
  const result = await apideck.hris.hrisDepartmentsDelete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisDepartmentsDelete } from "apideck/funcs/hrisHrisDepartmentsDelete.js";
...
async function run() {
  const res = await hrisHrisDepartmentsDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
...
async function run() {
  const result = await apideck.hris.hrisPayrollsAll({
    serviceId: "salesforce",
    filter: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisPayrollsAll } from "apideck/funcs/hrisHrisPayrollsAll.js";
...
async function run() {
  const res = await hrisHrisPayrollsAll(apideck, {
    serviceId: "salesforce",
    filter: {
      startDate: "2022-04-08",
      endDate: "2022-04-21",
...
async function run() {
  const result = await apideck.hris.hrisPayrollsOne({
    payrollId: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisPayrollsOne } from "apideck/funcs/hrisHrisPayrollsOne.js";
...
async function run() {
  const res = await hrisHrisPayrollsOne(apideck, {
    payrollId: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.hris.hrisEmployeePayrollsAll({
    employeeId: "<id>",
    serviceId: "salesforce",
    filter: {
      startDate: "2022-04-08",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeePayrollsAll } from "apideck/funcs/hrisHrisEmployeePayrollsAll.js";
...
async function run() {
  const res = await hrisHrisEmployeePayrollsAll(apideck, {
    employeeId: "<id>",
    serviceId: "salesforce",
    filter: {
      startDate: "2022-04-08",
...
async function run() {
  const result = await apideck.hris.hrisEmployeePayrollsOne({
    payrollId: "<id>",
    employeeId: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeePayrollsOne } from "apideck/funcs/hrisHrisEmployeePayrollsOne.js";
...
async function run() {
  const res = await hrisHrisEmployeePayrollsOne(apideck, {
    payrollId: "<id>",
    employeeId: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
...
async function run() {
  const result = await apideck.hris.hrisEmployeeSchedulesAll({
    employeeId: "<id>",
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisEmployeeSchedulesAll } from "apideck/funcs/hrisHrisEmployeeSchedulesAll.js";
...
async function run() {
  const res = await hrisHrisEmployeeSchedulesAll(apideck, {
    employeeId: "<id>",
    serviceId: "salesforce",
    passThrough: {
      "search": "San Francisco",
...
async function run() {
  const result = await apideck.hris.hrisTimeOffRequestsAll({
    serviceId: "salesforce",
    filter: {
      startDate: "2022-04-08",
      endDate: "2022-04-21",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisTimeOffRequestsAll } from "apideck/funcs/hrisHrisTimeOffRequestsAll.js";
...
async function run() {
  const res = await hrisHrisTimeOffRequestsAll(apideck, {
    serviceId: "salesforce",
    filter: {
      startDate: "2022-04-08",
      endDate: "2022-04-21",
...
async function run() {
  const result = await apideck.hris.hrisTimeOffRequestsAdd({
    serviceId: "salesforce",
    timeOffRequest: {
      employeeId: "12345",
      policyId: "12345",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisTimeOffRequestsAdd } from "apideck/funcs/hrisHrisTimeOffRequestsAdd.js";
...
async function run() {
  const res = await hrisHrisTimeOffRequestsAdd(apideck, {
    serviceId: "salesforce",
    timeOffRequest: {
      employeeId: "12345",
      policyId: "12345",
...
async function run() {
  const result = await apideck.hris.hrisTimeOffRequestsOne({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
    employeeId: "<id>",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisTimeOffRequestsOne } from "apideck/funcs/hrisHrisTimeOffRequestsOne.js";
...
async function run() {
  const res = await hrisHrisTimeOffRequestsOne(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
    employeeId: "<id>",
...
async function run() {
  const result = await apideck.hris.hrisTimeOffRequestsUpdate({
    id: "<id>",
    serviceId: "salesforce",
    employeeId: "<id>",
    timeOffRequest: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisTimeOffRequestsUpdate } from "apideck/funcs/hrisHrisTimeOffRequestsUpdate.js";
...
async function run() {
  const res = await hrisHrisTimeOffRequestsUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    employeeId: "<id>",
    timeOffRequest: {
...
async function run() {
  const result = await apideck.hris.hrisTimeOffRequestsDelete({
    id: "<id>",
    serviceId: "salesforce",
    employeeId: "<id>",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { hrisHrisTimeOffRequestsDelete } from "apideck/funcs/hrisHrisTimeOffRequestsDelete.js";
...
async function run() {
  const res = await hrisHrisTimeOffRequestsDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    employeeId: "<id>",
  });
