...
async function run() {
  const result = await apideck.pos.orderTypes.list({
...
import { posOrderTypesList } from "apideck/funcs/posOrderTypesList.js";
...
async function run() {
  const res = await posOrderTypesList(apideck, {
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.orderTypes.create({
    serviceId: "salesforce",
    orderType: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posOrderTypesCreate } from "apideck/funcs/posOrderTypesCreate.js";
...
async function run() {
  const res = await posOrderTypesCreate(apideck, {
    serviceId: "salesforce",
    orderType: {
      name: "Default order type",
      default: true,
...
async function run() {
  const result = await apideck.pos.orderTypes.get({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posOrderTypesGet } from "apideck/funcs/posOrderTypesGet.js";
...
async function run() {
  const res = await posOrderTypesGet(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.orderTypes.update({
    id: "<id>",
    serviceId: "salesforce",
    orderType: {
      name: "Default order type",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posOrderTypesUpdate } from "apideck/funcs/posOrderTypesUpdate.js";
...
async function run() {
  const res = await posOrderTypesUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    orderType: {
      name: "Default order type",
...
async function run() {
  const result = await apideck.pos.orderTypes.delete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posOrderTypesDelete } from "apideck/funcs/posOrderTypesDelete.js";
...
async function run() {
  const res = await posOrderTypesDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
