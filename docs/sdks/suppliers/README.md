...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingSuppliersList failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingSuppliersAllResponse](../../models/operations/accountingsuppliersallresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingSuppliersCreate failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingSuppliersAddResponse](../../models/operations/accountingsuppliersaddresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingSuppliersGet failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingSuppliersOneResponse](../../models/operations/accountingsuppliersoneresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingSuppliersUpdate failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingSuppliersUpdateResponse](../../models/operations/accountingsuppliersupdateresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingSuppliersDelete failed:", res.error);
  }
}
