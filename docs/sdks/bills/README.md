...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBillsList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBillsCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBillsGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBillsUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBillsDelete failed:", res.error);
  }
}
