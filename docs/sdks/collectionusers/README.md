...
import { issueTrackingCollectionUsersList } from "apideck/funcs/issueTrackingCollectionUsersList.js";
...
**Promise\<[operations.IssueTrackingCollectionUsersAllResponse](../../models/operations/issuetrackingcollectionusersallresponse.md)\>**
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { issueTrackingCollectionUsersGet } from "apideck/funcs/issueTrackingCollectionUsersGet.js";
...
async function run() {
  const res = await issueTrackingCollectionUsersGet(apideck, {
    collectionId: "apideck-io",
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
...
**Promise\<[operations.IssueTrackingCollectionUsersOneResponse](../../models/operations/issuetrackingcollectionusersoneresponse.md)\>**
