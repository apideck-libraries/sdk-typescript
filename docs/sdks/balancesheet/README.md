...
<!-- UsageSnippet language="typescript" operationID="accounting.balanceSheetOne" method="get" path="/accounting/balance-sheet" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingBalanceSheetGet failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingBalanceSheetOneResponse](../../models/operations/accountingbalancesheetoneresponse.md)\>**
