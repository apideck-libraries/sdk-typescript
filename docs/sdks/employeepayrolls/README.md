...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("hrisEmployeePayrollsList failed:", res.error);
  }
}
...
**Promise\<[operations.HrisEmployeePayrollsAllResponse](../../models/operations/hrisemployeepayrollsallresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("hrisEmployeePayrollsGet failed:", res.error);
  }
}
