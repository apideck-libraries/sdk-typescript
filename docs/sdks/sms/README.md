...
* [smsMessagesAll](#smsmessagesall) - List Messages
* [smsMessagesAdd](#smsmessagesadd) - Create Message
* [smsMessagesOne](#smsmessagesone) - Get Message
* [smsMessagesUpdate](#smsmessagesupdate) - Update Message
* [smsMessagesDelete](#smsmessagesdelete) - Delete Message
...
async function run() {
  const result = await apideck.sms.smsMessagesAll({
...
import { smsSmsMessagesAll } from "apideck/funcs/smsSmsMessagesAll.js";
...
async function run() {
  const res = await smsSmsMessagesAll(apideck, {
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.sms.smsMessagesAdd({
    serviceId: "salesforce",
    message: {
      from: "+15017122661",
      to: "+15017122662",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { smsSmsMessagesAdd } from "apideck/funcs/smsSmsMessagesAdd.js";
...
async function run() {
  const res = await smsSmsMessagesAdd(apideck, {
    serviceId: "salesforce",
    message: {
      from: "+15017122661",
      to: "+15017122662",
...
async function run() {
  const result = await apideck.sms.smsMessagesOne({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { smsSmsMessagesOne } from "apideck/funcs/smsSmsMessagesOne.js";
...
async function run() {
  const res = await smsSmsMessagesOne(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.sms.smsMessagesUpdate({
    id: "<id>",
    serviceId: "salesforce",
    message: {
      from: "+15017122661",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { smsSmsMessagesUpdate } from "apideck/funcs/smsSmsMessagesUpdate.js";
...
async function run() {
  const res = await smsSmsMessagesUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    message: {
      from: "+15017122661",
...
async function run() {
  const result = await apideck.sms.smsMessagesDelete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { smsSmsMessagesDelete } from "apideck/funcs/smsSmsMessagesDelete.js";
...
async function run() {
  const res = await smsSmsMessagesDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
