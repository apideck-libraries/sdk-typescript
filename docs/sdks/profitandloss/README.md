...
<!-- UsageSnippet language="typescript" operationID="accounting.profitAndLossOne" method="get" path="/accounting/profit-and-loss" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingProfitAndLossGet failed:", res.error);
  }
}
...
**Promise\<[operations.AccountingProfitAndLossOneResponse](../../models/operations/accountingprofitandlossoneresponse.md)\>**
