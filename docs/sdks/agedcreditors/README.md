...
<!-- UsageSnippet language="typescript" operationID="accounting.agedCreditorsOne" method="get" path="/accounting/aged-creditors" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingAgedCreditorsGet failed:", res.error);
  }
}
