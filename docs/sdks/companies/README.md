...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmCompaniesList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmCompaniesCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmCompaniesGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmCompaniesUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmCompaniesDelete failed:", res.error);
  }
}
