...
import { posLocationsList } from "apideck/funcs/posLocationsList.js";
...
async function run() {
  const res = await posLocationsList(apideck, {
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.locations.create({
    serviceId: "salesforce",
    location: {
      name: "Dunkin Donuts",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posLocationsCreate } from "apideck/funcs/posLocationsCreate.js";
...
async function run() {
  const res = await posLocationsCreate(apideck, {
    serviceId: "salesforce",
    location: {
      name: "Dunkin Donuts",
      businessName: "Dunkin Donuts LLC",
...
async function run() {
  const result = await apideck.pos.locations.get({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posLocationsGet } from "apideck/funcs/posLocationsGet.js";
...
async function run() {
  const res = await posLocationsGet(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.locations.update({
    id: "<id>",
    serviceId: "salesforce",
    location: {
      name: "Dunkin Donuts",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posLocationsUpdate } from "apideck/funcs/posLocationsUpdate.js";
...
async function run() {
  const res = await posLocationsUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    location: {
      name: "Dunkin Donuts",
...
async function run() {
  const result = await apideck.pos.locations.delete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posLocationsDelete } from "apideck/funcs/posLocationsDelete.js";
...
async function run() {
  const res = await posLocationsDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
