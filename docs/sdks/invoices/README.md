...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingInvoicesList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingInvoicesCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingInvoicesGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingInvoicesUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingInvoicesDelete failed:", res.error);
  }
}
