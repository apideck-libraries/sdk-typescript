...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmLeadsList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmLeadsCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmLeadsGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmLeadsUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmLeadsDelete failed:", res.error);
  }
}
