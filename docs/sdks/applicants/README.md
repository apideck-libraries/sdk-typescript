...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsApplicantsList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsApplicantsCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsApplicantsGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsApplicantsUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsApplicantsDelete failed:", res.error);
  }
}
