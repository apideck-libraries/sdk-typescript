...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageSharedLinksList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageSharedLinksCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageSharedLinksGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageSharedLinksUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageSharedLinksDelete failed:", res.error);
  }
}
