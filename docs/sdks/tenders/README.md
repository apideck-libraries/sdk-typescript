...
async function run() {
  const result = await apideck.pos.tenders.list({
...
import { posTendersList } from "apideck/funcs/posTendersList.js";
...
async function run() {
  const res = await posTendersList(apideck, {
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.tenders.create({
    serviceId: "salesforce",
    tender: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posTendersCreate } from "apideck/funcs/posTendersCreate.js";
...
async function run() {
  const res = await posTendersCreate(apideck, {
    serviceId: "salesforce",
    tender: {
      key: "com.clover.tender.cash",
      label: "Cash",
...
async function run() {
  const result = await apideck.pos.tenders.get({
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posTendersGet } from "apideck/funcs/posTendersGet.js";
...
async function run() {
  const res = await posTendersGet(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.tenders.update({
    id: "<id>",
    serviceId: "salesforce",
    tender: {
      key: "com.clover.tender.cash",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posTendersUpdate } from "apideck/funcs/posTendersUpdate.js";
...
async function run() {
  const res = await posTendersUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    tender: {
      key: "com.clover.tender.cash",
...
async function run() {
  const result = await apideck.pos.tenders.delete({
    id: "<id>",
    serviceId: "salesforce",
  });
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posTendersDelete } from "apideck/funcs/posTendersDelete.js";
...
async function run() {
  const res = await posTendersDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
