...
<!-- UsageSnippet language="typescript" operationID="issueTracking.collectionTagsAll" method="get" path="/issue-tracking/collections/{collection_id}/tags" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("issueTrackingCollectionTagsList failed:", res.error);
  }
}
...
**Promise\<[operations.IssueTrackingCollectionTagsAllResponse](../../models/operations/issuetrackingcollectiontagsallresponse.md)\>**
