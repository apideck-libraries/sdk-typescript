...
async function run() {
  const result = await apideck.pos.modifiers.list({
...
import { posModifiersList } from "apideck/funcs/posModifiersList.js";
...
async function run() {
  const res = await posModifiersList(apideck, {
    serviceId: "salesforce",
    fields: "id,updated_at",
  });
...
async function run() {
  const result = await apideck.pos.modifiers.create({
    serviceId: "salesforce",
    modifier: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posModifiersCreate } from "apideck/funcs/posModifiersCreate.js";
...
async function run() {
  const res = await posModifiersCreate(apideck, {
    serviceId: "salesforce",
    modifier: {
      idempotencyKey: "random_string",
      name: "Modifier",
...
async function run() {
  const result = await apideck.pos.modifiers.get({
    id: "<id>",
    serviceId: "salesforce",
    filter: {
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posModifiersGet } from "apideck/funcs/posModifiersGet.js";
...
async function run() {
  const res = await posModifiersGet(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    filter: {
      modifierGroupId: "1234",
...
async function run() {
  const result = await apideck.pos.modifiers.update({
    id: "<id>",
    serviceId: "salesforce",
    modifier: {
      idempotencyKey: "random_string",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posModifiersUpdate } from "apideck/funcs/posModifiersUpdate.js";
...
async function run() {
  const res = await posModifiersUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    modifier: {
      idempotencyKey: "random_string",
...
async function run() {
  const result = await apideck.pos.modifiers.delete({
    id: "<id>",
    serviceId: "salesforce",
    filter: {
      modifierGroupId: "1234",
...
```typescript
import { ApideckCore } from "apideck/core.js";
import { posModifiersDelete } from "apideck/funcs/posModifiersDelete.js";
...
async function run() {
  const res = await posModifiersDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    filter: {
      modifierGroupId: "1234",
