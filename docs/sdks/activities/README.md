...
import { crmActivitiesList } from "@apideck/unify/funcs/crmActivitiesList.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmActivitiesList failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmActivitiesCreate } from "@apideck/unify/funcs/crmActivitiesCreate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmActivitiesCreate failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmActivitiesGet } from "@apideck/unify/funcs/crmActivitiesGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmActivitiesGet failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmActivitiesUpdate } from "@apideck/unify/funcs/crmActivitiesUpdate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmActivitiesUpdate failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmActivitiesDelete } from "@apideck/unify/funcs/crmActivitiesDelete.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmActivitiesDelete failed:", res.error);
  }
}
