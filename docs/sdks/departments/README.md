...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingDepartmentsList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingDepartmentsCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingDepartmentsGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingDepartmentsUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("accountingDepartmentsDelete failed:", res.error);
  }
}
