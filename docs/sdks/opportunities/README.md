...
import { crmOpportunitiesList } from "@apideck/unify/funcs/crmOpportunitiesList.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmOpportunitiesList failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmOpportunitiesCreate failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmOpportunitiesGet } from "@apideck/unify/funcs/crmOpportunitiesGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmOpportunitiesGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmOpportunitiesUpdate failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { crmOpportunitiesDelete } from "@apideck/unify/funcs/crmOpportunitiesDelete.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("crmOpportunitiesDelete failed:", res.error);
  }
}
