...
<!-- UsageSnippet language="typescript" operationID="issueTracking.collectionsAll" method="get" path="/issue-tracking/collections" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("issueTrackingCollectionsList failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="issueTracking.collectionsOne" method="get" path="/issue-tracking/collections/{collection_id}" -->
```typescript
import { Apideck } from "@apideck/unify";
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { issueTrackingCollectionsGet } from "@apideck/unify/funcs/issueTrackingCollectionsGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("issueTrackingCollectionsGet failed:", res.error);
  }
}
