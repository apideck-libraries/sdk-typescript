...
<!-- UsageSnippet language="typescript" operationID="ats.jobsAdd" method="post" path="/ats/jobs" -->
```typescript
import { Apideck } from "@apideck/unify";
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { atsJobsCreate } from "@apideck/unify/funcs/atsJobsCreate.js";
...
async function run() {
  const res = await atsJobsCreate(apideck, {
    serviceId: "salesforce",
    job: {
      slug: "ceo",
      title: "CEO",
  ...
  if (res.ok) {
    ...
    console.log("atsJobsCreate failed:", res.error);
  }
}
...
**Promise\<[operations.AtsJobsAddResponse](../../models/operations/atsjobsaddresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="ats.jobsUpdate" method="patch" path="/ats/jobs/{id}" -->
```typescript
import { Apideck } from "@apideck/unify";
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { atsJobsUpdate } from "@apideck/unify/funcs/atsJobsUpdate.js";
...
async function run() {
  const res = await atsJobsUpdate(apideck, {
    id: "<id>",
    serviceId: "salesforce",
    job: {
      slug: "ceo",
  ...
  if (res.ok) {
    ...
    console.log("atsJobsUpdate failed:", res.error);
  }
}
...
**Promise\<[operations.AtsJobsUpdateResponse](../../models/operations/atsjobsupdateresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="ats.jobsDelete" method="delete" path="/ats/jobs/{id}" -->
```typescript
import { Apideck } from "@apideck/unify";
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { atsJobsDelete } from "@apideck/unify/funcs/atsJobsDelete.js";
...
async function run() {
  const res = await atsJobsDelete(apideck, {
    id: "<id>",
    serviceId: "salesforce",
  });
  if (res.ok) {
    ...
    console.log("atsJobsDelete failed:", res.error);
  }
}
...
**Promise\<[operations.AtsJobsDeleteResponse](../../models/operations/atsjobsdeleteresponse.md)\>**
