...
import { atsJobsList } from "@apideck/unify/funcs/atsJobsList.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsJobsList failed:", res.error);
  }
}
...
```typescript
import { ApideckCore } from "@apideck/unify/core.js";
import { atsJobsGet } from "@apideck/unify/funcs/atsJobsGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("atsJobsGet failed:", res.error);
  }
}
