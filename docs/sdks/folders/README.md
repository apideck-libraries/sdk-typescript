...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageFoldersCreate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageFoldersGet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageFoldersUpdate failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageFoldersDelete failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("fileStorageFoldersCopy failed:", res.error);
  }
}
