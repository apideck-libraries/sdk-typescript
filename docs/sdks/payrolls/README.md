...
<!-- UsageSnippet language="typescript" operationID="hris.payrollsAll" method="get" path="/hris/payrolls" -->
```typescript
...
**Promise\<[operations.HrisPayrollsAllResponse](../../models/operations/hrispayrollsallresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="hris.payrollsOne" method="get" path="/hris/payrolls/{payroll_id}" -->
```typescript
import { Apideck } from "@apideck/unify";
...
**Promise\<[operations.HrisPayrollsOneResponse](../../models/operations/hrispayrollsoneresponse.md)\>**
